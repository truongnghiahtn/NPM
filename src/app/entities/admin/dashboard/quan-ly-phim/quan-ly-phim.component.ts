...
export class QuanLyPhimComponent implements OnInit {
  ...
  layDanhSachPhim(maNhom) {
    this.dataService.get(`http://movie0706.cybersoft.edu.vn/api/QuanLyPhim/LayDanhSachPhim?maNhom=${maNhom}`).subscribe((data: Phim[]) => {
      this.danhSachPhim = data;
    })
  }

  themPhim() {
    this.dataService.post(`http://movie0706.cybersoft.edu.vn/api/QuanLyPhim/ThemPhim`, this.formPhim.value).subscribe((data: any) => {
      console.log(data);
  ...
  Update() {
    this.dataService.post(`http://movie0706.cybersoft.edu.vn/api/QuanLyPhim/CapNhatPhim`, this.formPhim.value).subscribe((data: any) => {
      console.log(data);
      this.layDanhSachPhim(data.maNhom);
  ...
  Delete(Phim: Phim) {
    this.dataService.deletePhim(`http://movie0706.cybersoft.edu.vn/api/QuanLyPhim/XoaPhim?MaPhim=${Phim.maPhim}`).subscribe((data: any) => {
      console.log(data);
